...
![Windows](https://img.shields.io/badge/Windows%20(v1.4.6)-0078D6?logo=windows&logoColor=white)
![macOS](https://img.shields.io/badge/macOS%20(v1.4.6)-000000?logo=apple&logoColor=white)
![Version](https://img.shields.io/badge/version-1.4.6-brightgreen.svg)
![License](https://img.shields.io/badge/license-MIT-green.svg)

基于 **Python + Tkinter** 的深色主题桌面倒计时工具（完整模式 + Mini 小组件）。

**当前版本：1.4.6**（变更见 [CHANGELOG.md](CHANGELOG.md)）
...
- **检查更新**：可在启动时自动检查 GitHub Release，或在「关于」中手动检查；支持忽略版本；下载可取消；**强制 SHA256**
  （无校验资产时禁止应用内下载/安装，改为浏览器打开发布页）
...
版本号读取自 `core.countdown_core.__version__`（当前 **1.4.6**）。CI 打 tag 时要求 tag 与代码版本一致。
