...
![Windows](https://img.shields.io/badge/Windows%20(v1.3.29)-0078D6?logo=windows&logoColor=white)
![macOS](https://img.shields.io/badge/macOS%20(v1.3.29)-000000?logo=apple&logoColor=white)
![Version](https://img.shields.io/badge/version-1.3.29-brightgreen.svg)
![License](https://img.shields.io/badge/license-MIT-green.svg)

基于 **Python + Tkinter** 的深色主题桌面倒计时工具（完整模式 + Mini 小组件）。

**当前版本：1.3.29**（变更见 [CHANGELOG.md](CHANGELOG.md)）
...
版本号读取自 `core.countdown_core.__version__`（当前 **1.3.29**）。CI 打 tag 时要求 tag 与代码版本一致。
