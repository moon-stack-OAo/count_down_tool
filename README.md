...
![Windows](https://img.shields.io/badge/Windows%20(v1.3.20)-0078D6?logo=windows&logoColor=white)
![macOS](https://img.shields.io/badge/macOS%20(v1.3.20)-000000?logo=apple&logoColor=white)
![Version](https://img.shields.io/badge/version-1.3.20-brightgreen.svg)
![License](https://img.shields.io/badge/license-MIT-green.svg)

一个基于 Python Tkinter 的现代化深色主题桌面倒计时工具，支持完整模式和 Mini 桌面小组件模式。

**当前版本：1.3.20**（变更见 [CHANGELOG.md](CHANGELOG.md)）
